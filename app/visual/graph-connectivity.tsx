...
const ConnectivityGraph: React.FC<Props> = ({ json, messageId }: Props) => {
  ...
  React.useEffect(() => {
    if (json) {
      ...
      const nodes = forcedata.nodes.map((d: any) => ({
        ...d,
        color: forcedata.connectedComponents?.includes(d.id)
          ? "#2ca02c"
          : "#1f77b4",
      }));
      ...
      function startAllAnimations() {
        ...
        svgT
          ...
          .then(() => {
            if (forcedata.connectedPath) {
              animateConnectedPaths(forcedata.connectedPath, nodess);
            }
          });
      }
                ...
                svgT
                  ...
                  .filter(
                    (d: any) =>
                      ...
                      (d.source.id === nextId && d.target.id === id),
                  )
                  .transition()
                  .duration(1000)
